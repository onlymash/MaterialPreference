...
import rikka.materialpreference.DialogPreference;
import rikka.materialpreference.PreferenceDialogFragment;

/**
 * Created by Rikka on 2016/10/7.
 */
...
public class NumberPickerPreference extends DialogPreference {
    ...
    public NumberPickerPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        a = context.obtainStyledAttributes(attrs,
                rikka.materialpreference.R.styleable.Preference, defStyleAttr, defStyleRes);

        mSummary = TypedArrayUtils.getString(a, rikka.materialpreference.R.styleable.Preference_summary,
                rikka.materialpreference.R.styleable.Preference_android_summary);
    ...
    public NumberPickerPreference(Context context, AttributeSet attrs) {
        this(context, attrs, rikka.materialpreference.R.attr.dialogPreferenceStyle);
    }
